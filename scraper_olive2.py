...
url = "https://global.oliveyoung.com/product/detail?prdtNo=GA220414400&dataSource=top_orders"
...
if scraped_reviews:
    ...
    df.to_excel('olive_young_alba_reviews.xlsx', index=False)
    print(f"\nSuccess! Scraped a total of {len(scraped_reviews)} unique global reviews and saved to olive_young_alba_reviews.xlsx")
else:
